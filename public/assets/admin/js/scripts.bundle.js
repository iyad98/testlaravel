...
var KTCard = function(elementId, options) {
    ...
    var Plugin = {
        ...
        init: function(options) {
            ...
            the.header = KTUtil.child(element, '.card-head');
            ...
            window.addEventListener('scroll', function() {
                ...
                if (
                    ...
                    if (st > offset && lastScrollTop < st) { // down scroll mode
                        if (body.hasAttribute('data-head-scroll') === false) {
                            body.setAttribute('data-head-scroll', 'on');
                        }
                        ...
                        if (body.hasAttribute('data-head-scroll') === true) {
                            body.removeAttribute('data-head-scroll');
                        }
	...
	$.fn[pluginName] = function(options) {
		...
		var Plugin = {
			...
			init: function(options) {
				...
				// if html table, remove and setup a new head
				if (isHtmlTable) {
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable-row').each(function() {
							...
							if ($(datatable.tableHead).find('.' + pfx + 'datatable-toggle-detail').length === 0) {
								// add empty column to the head and footer
								$(datatable.tableHead).
			...
			sorting: function() {
				var sortObj = {
					...
					setIcon: function() {
						...
						// set sorted class to head on init
			...
			initSelect: function() {
				...
				if (Extension.selectedAllRows && options.vars.requestIds) {
					if (!datatable.hasClass(pfx + 'datatable-error')) {
						// set head select all checkbox checked
...
var KTLayoutChat = function () {
	...
	var _init = function (element) {
		...
		var cardHeaderEl = KTUtil.find(element, '.card-head');
...
var KTLayoutDemoPanel = function() {
    ...
    var _init = function() {
        ...
        var header = KTUtil.find(_element, '.offcanvas-head');
...
var KTLayoutHeader = function() {
	...
	return {
        ...
        isFixed: function() {
            return KTUtil.hasClass(KTUtil.getBody(), 'head-fixed')
        },

        isFixedForMobile: function() {
            return KTUtil.hasClass(KTUtil.getBody(), 'head-mobile-fixed')
        },
			...
			sticky: {
				...
				position: {
					top: function() {
						...
						pos = pos - 1; // remove head border width
...
var KTLayoutStretchedCard = function() {
	...
	var _init = function() {
		...
		var cardHeader = KTUtil.find(_element, '.card-head');
